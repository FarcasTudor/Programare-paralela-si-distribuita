...
for ($i = 0; $i -lt $param6; $i++){
    ...
    $a = (cmd /c .\$param1 $param2 $param3 $param4 $param5 $param7 2>&1)
    if ($param7 -eq 0)
    {
...
if ($param7 -eq 0)
{
    Add-Content outC.csv "$param2 $param3 $param4,$param5 $tipRulare,$($suma1 / [int]$param6)"
}
else
{
    if ($param7 -eq 1)
    {
        Add-Content outC.csv "$param2 $param3 $param4,$param5 $tipRulare,$($suma2 / [int]$param6)"
    }
    else
    {
        Add-Content outC.csv "$param2 $param3 $param4,$param5 $tipRulare,$($suma1 / [int]$param6) $($suma2 / [int]$param6) $($suma / 2)"
    }
}